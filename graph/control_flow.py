...
from graph.edges.route_question_edge import route_question
...
from graph.nodes.simple_generation_node import simple_generation
...
workflow.add_node("simple_generation", simple_generation)  # simple generation
